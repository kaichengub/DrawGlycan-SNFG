...
% REPEATSTART          position where repeated units start
% REPEATEND              position where repeated units end
...
% This function is specifically designed to handle curly bracket item.
